...
if ($_POST['id_comunidad'] == 0) {
 ...
 '" . $_POST['telefono_cel'] . "','" . $_POST['observaciones'] . "')";
    ...
    if (!$rs) {
     ...
     $actualiza = "UPDATE comunidad  SET nombre_comunidad='".$_POST['nombre']."',rif='".$_POST['rif']."',correo='".$_POST['correo']."',
     estado='".$_POST['estado']."',municipio='".$_POST['municipio']."',parroquia='".$_POST['parroquia']."',
    direccion='".$_POST['direccion']."',convenio='".$_POST['convenio']."',tipo_convenio='".$_POST['tipo_convenio']."',
    telefono_hab='".$_POST['telefono_hab']."',telefono_cel='".$_POST['telefono_cel']."',observaciones='".$_POST['observaciones']."'
    where id_comunidad=".$_POST['id_comunidad'];
