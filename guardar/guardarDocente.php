...
if($_POST['id_docente']==0){
    ...
    dedicacion='".$_POST['dedicacion']."',ascenso='".$_POST['ascenso']."',fecha_ingreso='".$_POST['fecha_ingreso']."',investigacion='".$_POST['investigacion']."',
    observaciones='".$_POST['observaciones']."',id_carrera=".$_POST['id_carrera'];
    if(isset($_POST['guia'])) {
        $actualiza .=",guia=1";
    }else{
        $actualiza .=",guia=0";
