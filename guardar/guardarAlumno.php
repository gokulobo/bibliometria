...
if($_POST['id_alumno']==0){
    $inserta = "INSERT into alumnos(nombre,apellido,nacionalidad,cedula,carnet,grado_instruccion,correo,direccion_hab,
            telefono_hab,telefono_cel,id_cohorte,id_carrera,trayecto,trimestre,fecha_nac,lugar_nac) values('".$_POST['nombre']."',
            ...
            ".$_POST['cohorte'].",".$_POST['carrera'].",'".$_POST['trayecto']."','".$_POST['trimestre']."','".$_POST['fecha_nac']."','".$_POST['lugar_nac']."')";
    ...
    id_cohorte=".$_POST['cohorte'].", id_carrera=".$_POST['carrera'].",trayecto='".$_POST['trayecto']."',trimestre='".$_POST['trimestre']."'
     ,fecha_nac='".$_POST['fecha_nac']."' ,lugar_nac='".$_POST['lugar_nac']."' where id_alumno=".$_POST['id_alumno'];
