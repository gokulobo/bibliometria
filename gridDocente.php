...
$col["name"] = "id_docente"; // grid column name, same as db field or alias from sql
$col["hidden"] = true;
$cols[] = $col;
...
$col = array();
$col["title"] = "Profesion"; // caption of column, can use HTML tags too
$col["name"] = "profesion"; // grid column name, same as db field or alias from sql
$col["width"] = "60"; // width on grid
$col["editable"] = true;
$cols[] = $col;
