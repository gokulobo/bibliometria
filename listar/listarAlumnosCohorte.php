...
$based = ("SELECT alumnos.id_alumno as id,nombre,apellido,id_carrera,id_proyecto,cedula,trayecto,trimestre
FROM alumnos
...
if (mysql_num_rows($rs) > 0) {
    while ($fila = mysql_fetch_assoc($rs)) {
        $opciones .= "<option value='". $fila["id"]."'>". $fila["cedula"]."|".$fila["nombre"]." ".$fila["apellido"]
            ."|Trayecto:".$fila['trayecto']."|Trimestre:".$fila['trimestre']."</option>";
    }
}else{
