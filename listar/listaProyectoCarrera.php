...
$based = ("SELECT id_proyecto,titulo_proyecto FROM proyecto where cupo < 5 and id_carrera=".$_POST['carrera']);
...
if (mysql_num_rows($rs) > 0) {
    ...
    $opciones = "<option value='0'>No Hay Proyectos Disponibles</option>";
}
echo $opciones;
?>